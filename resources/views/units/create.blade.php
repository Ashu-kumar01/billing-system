<x-app-layout>
    <x-page-header title="New Unit" subtitle="Create a new product unit." />
        ...
        <form method="POST" action="{{ route('units.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <x-text-input id="short_name" name="short_name" type="text" class="mt-1" :value="old('short_name')" maxlength="20" required />
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-border">
                ...
                <x-primary-button>
                    <i class="fa-solid fa-check"></i> Save Unit
                </x-primary-button>
            </div>
        </form>
    </div>
